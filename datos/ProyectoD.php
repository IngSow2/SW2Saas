<?php 
	...
	class ProyectoD{
		...
		public function guardar($nombre,$nombrePropietario,$direccion,$responsable,$user){
		...
		public function listar(){//devuelve un array con todos los datos
			$query='select * from proyecto where user="'.$_SESSION['user'].'"';
